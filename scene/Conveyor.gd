...
var player_message_array: Array = [
	Notification.Message.new("Shift Supervisor", "Between you and me, I'd rather have 3 robots instead of you. Less questions"),
	...
	Notification.Message.new("Robot", "Beep boop bloop doop troop"),
